...
from khimera.plugins.core import Spec, Contrib, DependencySpec, CategorySpec
...
class PluginModel:
    ...
    >>> from khimera.plugins.core import MetaDataSpec
    ...
    >>> from khimera.plugins.core import CommandSpec
    ...
    >>> from khimera.plugins.core import APIExtensionSpec
    ...
    >>> from khimera.plugins.core import HookSpec
    ...
    >>> from khimera.plugins.core import AssetSpec
    ...
    >>> from khimera.plugins.core import MetaData
    ...
    @property
    def all_specs(self) -> TypeConstrainedDict[str, Spec]:
    ...
    def filter(self, category: Optional[Type[Contrib]] = None, unique: bool = False, required: bool = False) -> TypeConstrainedDict[str, CategorySpec]:
        """
